...
const Transition = () => {
  ...
  let tech = ["Node.js, Express, PostgreSQL, JWT, React, and Redux", "Node.js, Express, PostgreSQL, JWT, React (Vite.js), Redux and MUI", "Node.js, Express, MongoDB Atlas, JWT, Socket.IO, Google Cloud (Storage and Maps), ML5, Teachable Machine, React, Redux, MUI, PWA and AWS"]
  useEffect(() => {
